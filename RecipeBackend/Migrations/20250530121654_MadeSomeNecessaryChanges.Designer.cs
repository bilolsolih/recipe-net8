...
namespace RecipeBackend.Migrations
{
    ...
    [Migration("20250530121654_MadeSomeNecessaryChanges")]
    partial class MadeSomeNecessaryChanges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AllergicIngredientUser", b =>
                {
                    b.Property<int>("AllergicIngredientsId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("UserId")
                        .HasColumnType("INTEGER");

                    b.HasKey("AllergicIngredientsId", "UserId");

                    b.HasIndex("UserId");

                    b.ToTable("AllergicIngredientUser");
                });

            modelBuilder.Entity("CuisineUser", b =>
                {
                    ...
                    b.HasKey("CuisinesId", "UserId");

                    b.HasIndex("UserId");

                    b.ToTable("CuisineUser");
                });

            modelBuilder.Entity("RecipeBackend.Features.Authentication.Models.CookingLevel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                    ...
                    b.ToTable("cooking_levels", (string)null);
                });
            ...
            modelBuilder.Entity("AllergicIngredientUser", b =>
                {
                    b.HasOne("RecipeBackend.Features.Customization.Models.AllergicIngredient", null)
                        .WithMany()
                        .HasForeignKey("AllergicIngredientsId")
            ...
            modelBuilder.Entity("CuisineUser", b =>
                {
                    b.HasOne("RecipeBackend.Features.Customization.Models.Cuisine", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RecipeBackend.Features.Authentication.Models.User", b =>
                {
                    b.HasOne("RecipeBackend.Features.Authentication.Models.CookingLevel", "CookingLevel")
                        .WithMany("Users")
                        .HasForeignKey("CookingLevelId");

                    b.Navigation("CookingLevel");
                });
